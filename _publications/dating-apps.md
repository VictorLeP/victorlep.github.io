...
authors: "Dhondt, Karel; Le Pochat, Victor; Dimova, Yana; Joosen, Wouter; Volckaert, Stijn"
collection: publications
permalink: /publication/dating-apps
excerpt: "We analyze privacy risks in 15 location-based dating apps, asessing which personal and sensitive data is shared with other users, both as (intended) data exposure and as inadvertent API leaks, including exact user locations."
...
paperurl: '/files/dating-apps-usesec24.pdf'
bibtex: |
    @inproceedings{Dhondt2024DatingApps,
     author = {Dhondt, Karel and Le Pochat, Victor and Dimova, Yana and Joosen, Wouter and Volckaert, Stijn},
     title = {Swipe Left for Identity Theft: An Analysis of User Data Privacy Risks on Location-based Dating Apps},
